...
class ModuleRoute implements RouteInterface {
    ...
    protected function invokeClass($instance, $action, HttpContext $context, array $vars = []) {
        ...
        $this->refreshDefaultView($context);
...
//        4.一个是匹配 home 控制器 作为方法
    ...
    protected function refreshDefaultView(HttpContext $context) {
        /** @var ViewFactory $view */
        $view = $context['view'];
        if (isset($context['view_base'])) {
            $view->setDirectory($context['view_base']);
        }
        $context['view_controller_path'] = $this->getViewFolder(isset($context['module'])
     ...
     * @throws Exception
     */
    protected function getViewFolder($module, $controller): string {
